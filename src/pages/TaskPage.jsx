...
const TaskPage = () => {
    ...
    const fetchTaskRecords = async (page = 1, filters = appliedFilters) => {
        ...
        try {
            ...
            const response = await axios.get('https://tuition-seba-backend-16yx.onrender.com/api/taskData/all', {
                headers: { Authorization: token },
                params
            });
    ...
    const fetchSummaryCounts = async (filters = appliedFilters) => {
        try {
            ...
            const response = await axios.get('https://tuition-seba-backend-16yx.onrender.com/api/taskData/summary', {
                headers: { Authorization: token },
                params
            });
    ...
    const handleSaveTask = async (data) => {
        try {
            if (editingTask) {
                await axios.put(`https://tuition-seba-backend-16yx.onrender.com/api/taskData/edit/${editingTask._id}`, data, {
                    headers: { Authorization: token }
                });
                toast.success("Task updated successfully!");
            } else {
                await axios.post('https://tuition-seba-backend-16yx.onrender.com/api/taskData/add', data, {
                    headers: { Authorization: token }
                });
    ...
    const handleDeleteTask = async (id) => {
        ...
        if (confirmDelete) {
            try {
                await axios.delete(`https://tuition-seba-backend-16yx.onrender.com/api/taskData/delete/${id}`, {
                    headers: { Authorization: token }
                });
    ...
    const handleConfirmComplete = async () => {
        try {
            ...
            await axios.put(`https://tuition-seba-backend-16yx.onrender.com/api/taskData/edit/${completingTask._id}`, data, {
                headers: { Authorization: token }
            });
