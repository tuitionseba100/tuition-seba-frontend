...
const Dashboard = () => {
    ...
    const fetchPaymentSummary = () => {
        Promise.all([
            axios.get('https://tuition-seba-backend-a0pb.onrender.com/api/payment/summary'),
            axios.get('https://tuition-seba-backend-a0pb.onrender.com/api/teacherPayment/summary')
        ])
    ...
    const fetchData = () => {
        ...
        axios.get('https://tuition-seba-backend-a0pb.onrender.com/api/dashboard/all')
            .then((res) => {
                const data = res.data;
    ...
    const handleSaveEdit = async () => {
        try {
            await axios.put(`https://tuition-seba-backend-a0pb.onrender.com/api/teacherPayment/edit/${editingPayment._id}`, editingPayment);
