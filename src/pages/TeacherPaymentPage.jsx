...
const TeacherPaymentPage = () => {
    ...
    const fetchTeacherPaymentRecords = async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://tuition-seba-backend-1-vk5b.onrender.com/api/teacherPayment/getTableData', {
                params: {
                    page: currentPage,
    ...
    const fetchTeacherSummary = async () => {
        try {
            const res = await axios.get('https://tuition-seba-backend-1-vk5b.onrender.com/api/teacherPayment/summary', {
                params: {
                    tuitionCode: appliedFilters.tuitionCode,
                    personalPhone: appliedFilters.personalPhone,
                    paymentNumber: appliedFilters.paymentNumber,
    ...
    const handleExportWithStatus = async () => {
        if (selectedExportStatus) {
            try {
                ...
                link.href = `https://tuition-seba-backend-1-vk5b.onrender.com/api/teacherPayment/exportData?status=${selectedExportStatus}`;
                link.target = '_blank';
    ...
    const handleSaveTeacherPayment = async () => {
        ...
        try {
            if (teacherEditingId) {
                ...
                await axios.put(`https://tuition-seba-backend-1-vk5b.onrender.com/api/teacherPayment/edit/${teacherEditingId}`, updatedData);
                ...
                await axios.post('https://tuition-seba-backend-1-vk5b.onrender.com/api/teacherPayment/add', newData);
