...
import { FaEdit, FaTrashAlt, FaWhatsapp, FaSearch, FaUndo, FaChevronLeft, FaChevronRight, FaBell, FaInfoCircle, FaCalendarAlt, FaFileInvoiceDollar } from 'react-icons/fa';
                ...
                <Modal show={showConfirmModal} onHide={() => setShowConfirmModal(false)} centered size="md">
                    ...
                    <Modal.Footer className="border-0 p-3 pt-0">
                        ...
                        <Button variant="primary" onClick={performSave} disabled={loading}>
                            {loading ? <Spinner animation="border" size="sm" /> : 'Confirm & Save'}
                        </Button>
                    </Modal.Footer>
                </Modal>
