...
const ComplaintSuggestionAdminPage = () => {
    ...
    const fetchSummary = async () => {
        try {
            const res = await axios.get('https://tuition-seba-backend-16yx.onrender.com/api/complaintSuggestion/summary', {
    ...
    const fetchSubmissions = async () => {
        setLoading(true);
        try {
            const res = await axios.get('https://tuition-seba-backend-16yx.onrender.com/api/complaintSuggestion/list', {
                params: {
                    page: currentPage,
                    limit: 25,
                    ...appliedFilters
    ...
    const handleUpdateStatus = async () => {
        setUpdating(true);
        try {
            await axios.put(`https://tuition-seba-backend-16yx.onrender.com/api/complaintSuggestion/${selectedItem._id}/status`, {
                status: statusUpdate,
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`https://tuition-seba-backend-16yx.onrender.com/api/complaintSuggestion/${id}`, {
                headers: { Authorization: token }
            });
