...
const RefundPage = () => {
    ...
    const fetchRefundApplyRecords = useCallback(async (page = 1, filters = appliedFilters) => {
        ...
        try {
            ...
            const response = await axios.get('https://tuition-seba-backend-a0pb.onrender.com/api/refund/all', { params });
    ...
    const fetchSummaryCounts = async () => {
        try {
            const response = await axios.get('https://tuition-seba-backend-a0pb.onrender.com/api/refund/summary');
    ...
    const fetchAlertToday = async () => {
        try {
            const response = await axios.get('https://tuition-seba-backend-a0pb.onrender.com/api/refund/alert-today');
    ...
    const fetchServiceCharges = async (page = 1, searchOverride = null) => {
        ...
        try {
            ...
            const response = await axios.get(`https://tuition-seba-backend-a0pb.onrender.com/api/serviceCharge/all`, {
    ...
    const fetchServiceChargeSummary = async () => {
        try {
            const response = await axios.get(`https://tuition-seba-backend-a0pb.onrender.com/api/serviceCharge/summary`);
    ...
    const performSave = async () => {
        ...
        try {
            if (editingId) {
                ...
                await axios.put(`https://tuition-seba-backend-a0pb.onrender.com/api/refund/edit/${editingId}`, updatedData);
                toast.success("Refund record updated successfully!");
            } else {
                const newData = { ...updatedTuitionData, createdBy: username };
                await axios.post('https://tuition-seba-backend-a0pb.onrender.com/api/refund/add', newData);
    ...
    const handleDeleteRecord = async (id) => {
        if (window.confirm("Are you sure you want to delete this record?")) {
            try {
                await axios.delete(`https://tuition-seba-backend-a0pb.onrender.com/api/refund/delete/${id}`);
