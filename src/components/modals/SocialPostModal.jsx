...
const SocialPostModal = ({ show, onHide }) => {
        ...
        if (show) {
            const fetchAreaGroups = async () => {
                try {
                    ...
                    const response = await axios.get('https://tuition-seba-backend-16yx.onrender.com/api/settings', {
    ...
    const fetchTuitions = async () => {
        ...
        try {
            ...
            const response = await axios.get('https://tuition-seba-backend-16yx.onrender.com/api/tuition/post-data', {
                params,
                headers: { Authorization: token }
            });
