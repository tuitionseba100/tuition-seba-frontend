...
const StatusHistoryReportPage = () => {
    ...
    const fetchUsers = async () => {
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/user/users', {
    ...
    const fetchSettings = async () => {
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/settings/marketing_mediums', {
                headers: { Authorization: token }
            });
    ...
    const fetchMarketingReport = async () => {
        ...
        try {
            ...
            const res = await axios.get(`https://tuition-seba-backend-1-lpfs.onrender.com/api/report/marketing?${queryParams}`, {
                headers: { Authorization: token }
            });
    ...
    const fetchPaymentReport = async () => {
        ...
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/payment/route-report', {
    ...
    const fetchOverallReport = async () => {
        ...
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/payment/overall-report', {
    ...
    const fetchTodayStats = async () => {
        ...
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/statusHistory/today-report', {
    ...
    const fetchHistoryList = async () => {
        setLoading(true);
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/statusHistory/list', {
                params: {
                    page: currentPage,
                    limit: 25,
                    ...appliedFilters
    ...
    const fetchDateDetails = async (dateStr, type, pageNum) => {
        ...
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/payment/date-details', {
    ...
    const handleExportCSV = async () => {
        setExporting(true);
        try {
            const res = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/statusHistory/export-csv', {
                params: {
                    ...appliedFilters
                },
                headers: { Authorization: token },
