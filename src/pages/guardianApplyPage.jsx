...
import { Button, Table, Modal, Form, Row, Col, Card, Nav } from 'react-bootstrap';
...
const GuardianApplyPage = () => {
    ...
    const fetchDueTodayList = async () => {
        ...
        try {
            const response = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/guardianApply/today-followups');
    ...
    const fetchGuardianApplyRecords = async (page = 1) => {
        setLoading(true);
        try {
            const response = await axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/guardianApply/getTableData', {
                params: {
                    page: currentPage,
    ...
    const fetchCardSummary = () => {
        axios.get('https://tuition-seba-backend-1-lpfs.onrender.com/api/guardianApply/summary', {
            params: {
                page: currentPage,
                phone: appliedFilters.phone,
    ...
    const handleSaveRequest = async () => {
        ...
        try {
            if (editingId) {
                ...
                await axios.put(`https://tuition-seba-backend-1-lpfs.onrender.com/api/guardianApply/edit/${editingId}`, updatedData);
                toast.success("Record updated successfully!");
            } else {
                updatedData.createdBy = username;
                await axios.post('https://tuition-seba-backend-1-lpfs.onrender.com/api/guardianApply/add', updatedData);
    ...
    const handleUpdateStatus = async () => {
        ...
        try {
            const response = await axios.put(
                `https://tuition-seba-backend-1-lpfs.onrender.com/api/guardianApply/update-status/${selectedRecord._id}`,
                {
                    status: newStatus,
                    comment: newComment,
    ...
    const handleDeleteRecord = async (id) => {
        ...
        if (confirmDelete) {
            ...
            try {
                await axios.delete(`https://tuition-seba-backend-1-lpfs.onrender.com/api/guardianApply/delete/${id}`);
