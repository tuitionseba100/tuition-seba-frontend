...
const getRefundWhatsAppMessage = (refund, contactNumber = '01633920928') => {
...
const WhatsAppRefundModal = ({ show, onHide, refundData }) => {
    ...
    useEffect(() => {
        if (refundData && show) {
            ...
            setMessage(getRefundWhatsAppMessage(refundData, whatsappNumber || '01633920928'));
        }
    }, [refundData, show, whatsappNumber]);
