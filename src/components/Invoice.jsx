...
const PaymentInvoice = ({ payment, show, onClose }) => {
  ...
  const invoiceItems = [
    ...
    { label: "Personal Phone", value: payment?.personalPhone },
    { label: "Amount", value: `৳ ${parseFloat(payment?.amount || 0).toLocaleString()}` },
    { label: "Discount", value: `৳ ${parseFloat(payment?.discount || 0).toLocaleString()}` },
    { label: "Due Amount", value: `৳ ${parseFloat(payment?.dueAmount || 0).toLocaleString()}` },
    { label: "Total Amount", value: `৳ ${parseFloat(payment?.totalAmount || 0).toLocaleString()}` },
