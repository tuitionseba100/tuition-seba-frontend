...
const fieldConfig = [
    ...
    { name: 'status', label: 'Status', group: 'details', col: 4, type: 'select', options: ['available', 'given number', 'guardian meet', 'demo class running', '1st Demo Class', '2nd Demo Class', 'confirm', 'cancel'] },
