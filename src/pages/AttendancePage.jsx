...
const AttendancePage = () => {
    ...
    const fetchAttendance = async () => {
        ...
        try {
            const response = await axios.get('https://tuition-seba-backend-16yx.onrender.com/api/attendance', {
    ...
    const handleAction = async (actionType) => {
        ...
        try {
            const url = actionType === 'start'
                ? 'https://tuition-seba-backend-16yx.onrender.com/api/attendance/start'
                : 'https://tuition-seba-backend-16yx.onrender.com/api/attendance/end';
    ...
    const deleteAttendance = async (id) => {
        ...
        try {
            await axios.delete(`https://tuition-seba-backend-16yx.onrender.com/api/attendance/${id}`, {
                headers: { Authorization: token },
            });
    ...
    const handleEditSubmit = async () => {
        try {
            await axios.put(`https://tuition-seba-backend-16yx.onrender.com/api/attendance/edit/${editingAttendance._id}`, {
